...
function buildAuthorizationServerMetadata(req?: express.Request) {
  ...
  // DCR endpoint is now on NeonPanel API (RFC 7591 compliant)
  // NeonPanel API team has implemented DCR with Initial Access Token support
...
// DCR Proxy removed - NeonPanel API now handles DCR at https://my.neonpanel.com/oauth2/register
// The registration_endpoint in OAuth discovery metadata points to NeonPanel's DCR
