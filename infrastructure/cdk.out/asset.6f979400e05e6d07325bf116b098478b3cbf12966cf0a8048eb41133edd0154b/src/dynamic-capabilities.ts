 ...
 */
async function fetchNeonPanelSchema(): Promise<any> {
  const errors: string[] = [];
 ...
 */
async function getNeonPanelSchema(): Promise<any> {
  const now = Date.now();
 ...
 */
function extractCapabilitiesFromSchema(schema: any): any[] {
  ...
  const inventoryEndpoints: any[] = [];
  const financeEndpoints: any[] = [];
  const companyEndpoints: any[] = [];
  const warehouseEndpoints: any[] = [];
  const reportEndpoints: any[] = [];
  const importEndpoints: any[] = [];
 ...
 */
function buildInputSchema(endpoint: any): any {
 ...
 */
function buildOutputSchema(endpoint: any): any {
 ...
 */
export async function getFreshCapabilities(): Promise<any[]> {
  try {
 ...
 */
function getFallbackCapabilities(): any[] {
 ...
 */
export async function getApiMetadata(): Promise<any> {
  try {
    const schema = await getNeonPanelSchema();
    return {
