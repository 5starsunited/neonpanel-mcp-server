...
company_thresholds AS (
    SELECT
        ...
        -- STRENGTH (scp)
        COALESCE(
            MAX(CASE WHEN t.company_id = c.company_id AND t.tool = 'scp' AND t.signal_group = 'strength' AND t.metric = 'click_rate'    AND t.color = 'green'  THEN t.threshold_value END),
        ...
        COALESCE(
            MAX(CASE WHEN t.company_id = c.company_id AND t.tool = 'scp' AND t.signal_group = 'strength' AND t.metric = 'click_rate'    AND t.color = 'yellow' THEN t.threshold_value END),
        ...
        COALESCE(
            MAX(CASE WHEN t.company_id = c.company_id AND t.tool = 'scp' AND t.signal_group = 'strength' AND t.metric = 'purchase_rate' AND t.color = 'green'  THEN t.threshold_value END),
        ...
        COALESCE(
            MAX(CASE WHEN t.company_id = c.company_id AND t.tool = 'scp' AND t.signal_group = 'strength' AND t.metric = 'purchase_rate' AND t.color = 'yellow' THEN t.threshold_value END),
        ...
        -- WEAKNESS (scp)
        COALESCE(
            MAX(CASE WHEN t.company_id = c.company_id AND t.tool = 'scp' AND t.signal_group = 'weakness' AND t.metric = 'delta'         AND t.color = 'red'    THEN t.threshold_value END),
        ...
        COALESCE(
            MAX(CASE WHEN t.company_id = c.company_id AND t.tool = 'scp' AND t.signal_group = 'weakness' AND t.metric = 'click_rate'    AND t.color = 'red'    THEN t.threshold_value END),
        ...
        COALESCE(
            MAX(CASE WHEN t.company_id = c.company_id AND t.tool = 'scp' AND t.signal_group = 'weakness' AND t.metric = 'purchase_rate' AND t.color = 'red'    THEN t.threshold_value END),
        ...
        COALESCE(
            MAX(CASE WHEN t.company_id = c.company_id AND t.tool = 'scp' AND t.signal_group = 'weakness' AND t.metric = 'cart_add_rate' AND t.color = 'yellow' THEN t.threshold_value END),
        ...
        -- OPPORTUNITY (scp)
        COALESCE(
            MAX(CASE WHEN t.company_id = c.company_id AND t.tool = 'scp' AND t.signal_group = 'opportunity' AND t.metric = 'cvr_ratio'     AND t.color = 'green'  THEN t.threshold_value END),
        ...
        COALESCE(
            MAX(CASE WHEN t.company_id = c.company_id AND t.tool = 'scp' AND t.signal_group = 'opportunity' AND t.metric = 'purchase_rate' AND t.color = 'yellow' THEN t.threshold_value END),
        ...
        COALESCE(
            MAX(CASE WHEN t.company_id = c.company_id AND t.tool = 'scp' AND t.signal_group = 'opportunity' AND t.metric = 'click_rate'    AND t.color = 'yellow' THEN t.threshold_value END),
        ...
        -- CEILING (scp)
        COALESCE(
            MAX(CASE WHEN t.company_id = c.company_id AND t.tool = 'scp' AND t.signal_group = 'ceiling' AND t.metric = 'click_rate'    AND t.color = 'red'    THEN t.threshold_value END),
        ...
        COALESCE(
            MAX(CASE WHEN t.company_id = c.company_id AND t.tool = 'scp' AND t.signal_group = 'ceiling' AND t.metric = 'click_rate'    AND t.color = 'yellow' THEN t.threshold_value END),
        ...
        COALESCE(
            MAX(CASE WHEN t.company_id = c.company_id AND t.tool = 'scp' AND t.signal_group = 'ceiling' AND t.metric = 'purchase_rate' AND t.color = 'red'    THEN t.threshold_value END),
        ...
        COALESCE(
            MAX(CASE WHEN t.company_id = c.company_id AND t.tool = 'scp' AND t.signal_group = 'ceiling' AND t.metric = 'purchase_rate' AND t.color = 'yellow' THEN t.threshold_value END),
        ...
        -- GLOBAL TREND
        COALESCE(
            MAX(CASE WHEN t.company_id = c.company_id AND t.tool = 'global' AND t.signal_group = 'trend' AND t.metric = 'delta' AND t.color = 'green' THEN t.threshold_value END),
        ...
        COALESCE(
            MAX(CASE WHEN t.company_id = c.company_id AND t.tool = 'global' AND t.signal_group = 'trend' AND t.metric = 'delta' AND t.color = 'red'   THEN t.threshold_value END),
...
FROM with_deltas w
JOIN company_thresholds thr ON thr.company_id = w."Company ID"