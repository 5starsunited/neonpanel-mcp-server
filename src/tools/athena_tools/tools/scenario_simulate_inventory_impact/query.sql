-- Tool: scenario_simulate_inventory_impact
...
SELECT
  company_id,
  NULL AS summary_baseline_stockout_count,
  NULL AS summary_scenario_stockout_count,
  NULL AS summary_baseline_overstock_count,
  NULL AS summary_scenario_overstock_count,
  ...
  NULL AS items_baseline_days_to_oos,
  NULL AS items_scenario_days_to_oos,
  NULL AS items_delta_days_to_oos,
  NULL AS items_risk_change
