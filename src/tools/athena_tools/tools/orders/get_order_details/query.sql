...
items AS (
  SELECT
    h.order_id,
    CAST(h.created_time AS VARCHAR)                         AS created_time,
    CAST(h.last_updated_time AS VARCHAR)                    AS last_updated_time,
    ...
    CAST(h.fulfillment.ship_by_window.earliest_date_time AS VARCHAR) AS ship_by_earliest,
    CAST(h.fulfillment.ship_by_window.latest_date_time AS VARCHAR)   AS ship_by_latest,
