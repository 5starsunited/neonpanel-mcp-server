...
import {
  executeInventoryPoSchedule,
  inventoryPoScheduleInputSchema,
} from '../inventory_po_schedule/register';
...
export function registerSupplyChainListPoPlacementCandidatesTool(registry: ToolRegistry) {
  ...
  registry.register({
    ...
    execute: async (args, context) => {
      ...
      const result = await executeInventoryPoSchedule(legacyParsed, context);
